...
class GraphqlController {
    ...
    @QueryMapping
    fun greeting(@Argument name: String?): String = "Hello, ${name ?: "World"}!"
    ...
    @MutationMapping
    fun saveGreeting(@Argument message: String): Boolean {
    ...
    fun updateUser(@Argument id: String, @Argument input: UserInput): User? {
        return users[id]?.also { existingUser ->
            users[id] = existingUser.copy(
                name = input.name,
                email = input.email,
